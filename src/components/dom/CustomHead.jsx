...
const SITE_URL = 'https://zainghazanfar.vercel.app';
...
const getSchema = () => ({
  ...
  url: SITE_URL,
  image: OG_IMAGE,
  email: 'mailto:zain.ghazanfar@outlook.com',
  sameAs: ['https://www.linkedin.com/in/zain-ghazanfar/', 'https://github.com/ZainGhazanfarofficals', 'https://medium.com/@zainghazanfar'],
  alumniOf: [
    { '@type': 'Organization', name: 'Rookminiinfosolution' },
    { '@type': 'Organization', name: 'Neurocare' },
    { '@type': 'Organization', name: 'Reebcode' },
    { '@type': 'Organization', name: 'Educative' },
  ],
});
  ...
  return (
    <>
      <NextHead>
        ...
        <meta name="author" content="Zain Ghazanfar" />
