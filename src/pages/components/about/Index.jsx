    ...
    <section ref={rootRef} className={styles.root}>
      <div className={clsx(styles.nameContainer, 'layout-block-inner')}>
        <AppearTitle>
          ...
          <h1 className={clsx('h1', 'medium')}>Zain Ghazanfar!</h1>
        </AppearTitle>
      </div>
      ...
      <div className={clsx(styles.container, 'layout-grid-inner')}>
        ...
        <div className={clsx(styles.descWrapper)} ref={animatedImageRef}>
          <AppearTitle>
            <div className="p-l">“Every system and AI feature I build starts</div>
            <div className="p-l">with the same goal: turn complex problems</div>
            <div className="p-l">into something reliable, secure, and</div>
            <div className="p-l">genuinely useful for the people who need it”</div>
          </AppearTitle>
        </div>
        {!isMobile ? renderImageContainer() : null}
        <div className={clsx(styles.descWrapperBottom)}>
          {!isMobile ? (
            <AppearTitle key="desktop-descWrapperBottom">
              <h6 className="h6">
                A Senior Full Stack AI Engineer based in Lahore, Pakistan. With a strong focus on AI-driven systems, cloud architecture, and secure healthcare platforms. I specialize in bringing
                full-stack applications to life with clean, scalable, and efficient architecture.
              </h6>
            </AppearTitle>
          ) : (
