    ...
    <section ref={rootRef} className={clsx(styles.root)}>
      <div className={clsx(styles.topContainer, 'layout-grid-inner')}>
        <div className={styles.leftContainer}>
          <h2 className="h2">Scalable</h2>
          <h2 className={clsx('h2', 'bold')}>AI-Powered Systems</h2>
        </div>
        {!isMobile && (
          <h6 className={clsx('h6', styles.rightContainer)}>
            With years of experience across cloud and AI engineering, I build production systems that turn complex problems into reliable, real-time platforms. Join me in engineering your next system.
          </h6>
        )}
      </div>
