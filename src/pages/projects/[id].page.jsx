...
function Page({ id }) {
  ...
  const seo = useMemo(
    () => ({
      title: `Zain Ghazanfar - ${currentProject.title} Project`,
      description: `Check out my work on the ${currentProject.title} project, built at ${currentProject.company}, where I designed AI-powered backend systems and scalable application workflows.`,
      keywords: [
        `${currentProject.title} project`,
        `${currentProject.title} development`,
        `${currentProject.company} collaboration`,
        `Zain Ghazanfar ${currentProject.title}`,
        `AI engineering ${currentProject.title}`,
        `Backend development ${currentProject.title}`,
        `Cloud architecture ${currentProject.title}`,
        `API development ${currentProject.title}`,
      ],
    }),
    [currentProject],
  );
