...
const seo = {
  title: 'Zain Ghazanfar - Projects',
  description: 'Explore my portfolio of AI-powered platforms, from healthcare systems to marketplace and e-commerce applications built with Python, Node.js, and React.',
  keywords: [
    'Zain Ghazanfar Projects',
    'Portfolio Showcase',
    'AI Engineering Portfolio',
    'Healthcare Platform Projects',
